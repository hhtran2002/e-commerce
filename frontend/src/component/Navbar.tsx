...
import { FaUser,FaShoppingCart, FaUserShield, FaSignInAlt, FaSearch, FaSignOutAlt,
} from "react-icons/fa";
  ...
  return (
    <header>
      <div className="navbar-container">
        ...
        {/* Center - Logo */}
         <Link to="/">
    <img className="navbar-logo" src="https://res.cloudinary.com/dywqgsjss/image/upload/v1763815926/Stitched-logo_4x_xmduvg.png" alt="Logo" />
  </Link>
